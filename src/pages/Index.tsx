...
const Index = () => {
  ...
  return (
    <div className="min-h-screen" style={{ backgroundColor: '#E8F4F8' }}>
      {/* Navbar */}
      <nav className="fixed top-4 left-1/2 transform -translate-x-1/2 w-[95%] max-w-7xl bg-white/90 backdrop-blur-lg shadow-xl z-50 border border-blue-100 rounded-2xl">
        <div className="px-6">
          <div className="flex items-center justify-between h-20">
            <div className="flex items-center gap-3 group cursor-pointer" onClick={() => navigate('/')}>
              <div className="w-12 h-12 bg-gradient-to-br from-blue-500 via-blue-600 to-purple-600 rounded-xl flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform">
                <Shield className="w-7 h-7 text-white" />
              </div>
              <div>
                <span className="text-2xl font-bold bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">ASC</span>
                <p className="text-xs text-gray-500 -mt-1">Assurance Santé Connect</p>
              </div>
            </div>
      ...
      {/* Hero Slider */}
      <div className="relative h-[600px] overflow-hidden sticky top-0 z-0">
              ...
              <div className="absolute inset-0 flex items-center justify-center text-white">
                <div className="container mx-auto px-4 text-center">
                  ...
                  <div className="flex gap-4 justify-center">
                    ...
                    <Button size="lg" variant="outline" onClick={() => navigate('/login')} className="border-white text-white hover:bg-white/20 text-lg px-8 btn-ripple">
                      En savoir plus
                    </Button>
                  </div>
                </div>
      ...
      <footer id="contact" className="bg-gray-900 text-gray-300 py-16 relative z-50">
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-4 gap-12 mb-12">
            <div>
              <div className="flex items-center gap-2 mb-4">
                ...
                <span className="text-xl font-bold text-white">ASC</span>
              </div>
          ...
          <div className="border-t border-gray-800 pt-8 text-center text-gray-400">
            <p>&copy; 2024 Assurance Santé Connect. Tous droits réservés.</p>
          </div>
        </div>
      </footer>
